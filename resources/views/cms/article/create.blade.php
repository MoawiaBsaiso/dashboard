...
<div class="row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control" name="title" id="title" placeholder="Enter Name of Country">
                  </div>
                  <div class="form-group col-md-12">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="full_description" id="full_description" cols="50" rows="4" style="resize: none;" placeholder="Enter Full Description"></textarea>
                    </div>
                  </div>
