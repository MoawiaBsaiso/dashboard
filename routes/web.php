...
Route::prefix('cms/admin/')->middleware('auth:admin,author')->group(function () {
    ...
    Route::get('/create/articles/{id}', [ArticleController::class, 'createArticle'])->name('createArticles');
    Route::get('/index/articles/{id}', [ArticleController::class, 'indexArticle'])->name('indexArticles');
